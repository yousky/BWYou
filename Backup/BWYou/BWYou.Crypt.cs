...
namespace BWYou
{
    ...
    public class Crypt
    {
        ...
        byte[] k = System.Text.Encoding.Default.GetBytes((k11+k1+k3+k2+k15+k17+k16+k6+k8+k0+k12+k4+k13+k5+k7+k9+k14).PadLeft(des.KeySize/8, '$'));
        //기본으로 사용할 IV. IV의 크기는 24자 이상 가능
        byte[] r = System.Text.Encoding.Default.GetBytes((k14+k12+k6+k9+k6+k13+k2+k1+k6+k8+k4+k3+k16+k12+k11+k16+k8+k6+k9+k1+k8).PadLeft(des.KeySize/8, '$'));
